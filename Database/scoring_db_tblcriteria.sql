...
CREATE TABLE `tblcriteria` (
  ...
  `CriteriaName` varchar(45) DEFAULT NULL,
...
INSERT INTO `tblcriteria` VALUES (1,'Q and A',0.25),(2,'Gown',0.25),(3,'Beauty',0.25),(4,'Talent',0.25);
...
-- Dump completed on 2018-02-13 21:57:10
